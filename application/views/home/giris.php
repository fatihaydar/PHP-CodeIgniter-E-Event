        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="left_content">
                <div class="contact_area">
                    <h2 style="margin-left: 350px">Giriş Yap</h2>
                    <br>
                    <form style="margin-top: 35px" action="<?=base_url()?>/anasayfa/giris_yap" method="post" class="contact_form">
                        <input class="form-control" name="email" type="email" placeholder="E-mail*" required>

                        <input class="form-control" name="sifre" type="password" placeholder="Şifre*" required>


                        <input style="margin-top: 45px;margin-left: 580px;width: 130px" type="submit" value="Giriş">
                        <h4><?php if ($uyari){
