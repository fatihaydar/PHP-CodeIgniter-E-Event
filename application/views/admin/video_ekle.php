    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
                <a href="<?=base_url()?>admin/home/video_ekle">Video Ekle</a>
        </li>
    </ol>
    <body >
            ...
            <form method="post" action="<?=base_url()?>admin/home/video_ekle_kaydet/<?=$this->session->admin_session["id"]?>">
                ...
                <label for="name">Video Linki (sadece src kısmı*)</label>
                <input  type="text" id="name" name="ytvideo" >
