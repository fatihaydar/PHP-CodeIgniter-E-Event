...
(function ($) {
    ...
    var bordered = $('<div class="border-left"></div><div class="border-right"></div><div class="border-top"></div><div class="border-bottom"></div>');

    // check the wrapper is avilable, if available
    // do nothing. if not then
    // wrap all element with wrapper

    $("body").removeClass("boxed").addClass("bordered");
    $("#wrapper").removeClass("main-wrapper boxed").addClass("bordered");

    if ($("body").hasClass("bordered")) {
        if($("#wrapper").is(":visible")) {

        }else {
            $("body > header, body > main, body > section, body > div , body > aside , body > footer").wrapAll('<div id="wrapper" class="bordered"></div>');
        }

        $("body").find("#wrapper").removeClass("main-wrapper");
        $("body").find("#wrapper").prepend(bordered);
    }
